...
m_and_m.onclick = () => {
 ...
 localStorage.setItem("M&M" , JSON.stringify(m_and_m))
}
...
freedent.onclick = () => {
 ...
 localStorage.setItem("Freedent" , JSON.stringify(freedent))
}
...
crunch.onclick = () => {
 ...
 localStorage.setItem("Crunch" , JSON.stringify(crunch))
}
...
bounty.onclick = () => {
 ...
 localStorage.setItem("Bounty" , JSON.stringify(bounty))
}
